...
const ETFS = {
  offensive: [
    ...
    { isin: "IE00BDBRDM35", ticker: "AGGH.L", shortName: "Global Agg EUR", name: "iShares Global Aggregate EUR Hdg", type: "bond" },
  ],
  defensive: [
    { isin: "IE00BF59RX87", ticker: "IEBC.AS", shortName: "Corp Bond EUR", name: "iShares € Corp Bond", type: "bond" },
    { isin: "IE00BMYHQM42", ticker: "GLDE.DE", shortName: "Govt Bond EUR", name: "SPDR Bloomberg Euro Govt Bond", type: "bond" },
